class Oobo < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/ooboai/oobo/releases/download/v#{version}/oobo-v#{version}-aarch64-apple-darwin.tar.gz"
      sha256 "651645d5effec9a2b2bb1fbb98c25d2f7fd4a292bf506dc2cd8565c1f11656c6"
    end
    on_intel do
      url "https://github.com/ooboai/oobo/releases/download/v#{version}/oobo-v#{version}-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/ooboai/oobo/releases/download/v#{version}/oobo-v#{version}-aarch64-unknown-linux-musl.tar.gz"
      sha256 "0b5c6e43c8815fbbaa87a3daec0dbf697d74398f4c62d8a3ca4c04aa8230ba77"
    end
    on_intel do
      url "https://github.com/ooboai/oobo/releases/download/v#{version}/oobo-v#{version}-x86_64-unknown-linux-musl.tar.gz"
